# Exercise 023 — Square Value Calculator
...
```bash
pytest 01_core_python/level_1_beginner/tests/test_023_square_value_calculator.py -v
```
...
```
01_core_python/level_1_beginner/solutions/023_square_value_calculator.py
```
