# Exercise 029 — String Integer Sum
...
```bash
pytest 01_core_python/level_1_beginner/tests/test_029_string_integer_sum.py -v
```
...
```
01_core_python/level_1_beginner/solutions/029_string_integer_sum.py
```
