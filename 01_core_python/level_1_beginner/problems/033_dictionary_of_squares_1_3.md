# Exercise 033 — Dictionary of Squares 1-3
...
```bash
pytest 01_core_python/level_1_beginner/tests/test_033_dictionary_of_squares_1_3.py -v
```
...
```
01_core_python/level_1_beginner/solutions/033_dictionary_of_squares_1_3.py
```
