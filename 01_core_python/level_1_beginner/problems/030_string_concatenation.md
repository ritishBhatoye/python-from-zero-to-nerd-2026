# Exercise 030 — String Concatenation
...
```bash
pytest 01_core_python/level_1_beginner/tests/test_030_string_concatenation.py -v
```
...
```
01_core_python/level_1_beginner/solutions/030_string_concatenation.py
```
