# Exercise 037 — List of Squares

**Phase:** `01_core_python`  
**Level:** 1 — Beginner  
**Source:** zhiwehu/Python-programming-exercises Q37  
**Status:** 🔴 Not started
...
```bash
pytest 01_core_python/level_1_beginner/tests/test_037_list_of_squares.py -v
```
...
```
01_core_python/level_1_beginner/solutions/037_list_of_squares.py
```
