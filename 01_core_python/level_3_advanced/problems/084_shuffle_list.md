...
Shuffle and print list [3,6,7,8].
...
```bash
pytest 01_core_python/level_3_advanced/tests/test_084_shuffle_list.py -v
```
...
```
01_core_python/level_3_advanced/solutions/084_shuffle_list.py
```
