# Exercise 055 — Raise RuntimeError
...
```bash
pytest 01_core_python/level_3_advanced/tests/test_055_raise_runtimeerror.py -v
```
...
```
01_core_python/level_3_advanced/solutions/055_raise_runtimeerror.py
```
