# Exercise 096 — Character Count

**Phase:** `01_core_python`  
**Level:** 3 — Advanced  
**Source:** zhiwehu/Python-programming-exercises Q96  
**Status:** 🔴 Not started
...
```bash
pytest 01_core_python/level_3_advanced/tests/test_096_character_count.py -v
```
...
```
01_core_python/level_3_advanced/solutions/096_character_count.py
```
