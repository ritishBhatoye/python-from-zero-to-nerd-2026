...
**Source:** zhiwehu/Python-programming-exercises Q8  
**Status:** 🔴 Not started
...
```bash
pytest 01_core_python/level_2_intermediate/tests/test_008_sort_words_alphabetically.py -v
```
...
```
01_core_python/level_2_intermediate/solutions/008_sort_words_alphabetically.py
```
