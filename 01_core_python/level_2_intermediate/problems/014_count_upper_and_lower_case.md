# Exercise 014 — Count Upper and Lower Case
...
```bash
pytest 01_core_python/level_2_intermediate/tests/test_014_count_upper_and_lower_case.py -v
```
...
```
01_core_python/level_2_intermediate/solutions/014_count_upper_and_lower_case.py
```
